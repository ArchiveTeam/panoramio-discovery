...
class CustomProcessArgs(object):
    def realize(self, item):
        ...
        if item_type == 'image':
            # Expect something like image:0-99999 or page:100000-199999
...
project = Project(
    title="Panoramio Discovery",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/1/17/Panoramio_logo.jpg" height="50px" title=""/>
        <h2>Panoramio Phase 1.
        <span class="links">
             <a href="http://www.panoramio.com/">Website</a> &middot;
             <a href="http://tracker.archiveteam.org/panoramiodisco/">Leaderboard</a>
             <a href="http://archiveteam.org/index.php?title=Panoramio">Wiki</a> &middot;
         </span>
        </h2>
        <p>Panoramio shuts down. This is phase 1: content discovery.</p>
    """,
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="panoramiodisco"),
